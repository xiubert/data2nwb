...
def genNWBfromScanImage_pc(experimentID: str, dataPath: str, NWBoutputPath: str,
    ...
    if pulsesMatFiles:
        ...
        (pulseTifs, pulseTifTypes, stimDelays, ISIs,
         pulseNames, pulseSets, xsg, treatments) = lib.mat2py.getPulsesFromLegend(legendMat)
    ...
    pulseFrameRates, pulseTreatments = [], []
    for tif, treat in zip(pulseTifs, treatments):
    ...
    stimData = {
        ...
        'treatment': ('treatment', pulseTreatments),
